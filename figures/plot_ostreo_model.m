...
figure;
    ...
    ylabel('gene copies ml^{-1}','FontSize',n);set(gca,'FontSize',n)
...
figure;
    ...
    ylabel('gene copies ml^{-1}','FontSize',n,'FontName','Helvetica');set(gca,'FontSize',n,'FontName','Helvetica','XTick',33.2:0.2:34.4)
